...
// Write the SQL Query
$grid->SelectCommand = "SELECT id,id_sekolah,id_tingkat,NISS,detail_kelas,Kelas,Kelas_Pondok, Nama_Lengkap,NO_KTP, Nama_Panggilan, Jenis_Kelamin, Tempat_Lahir, Tanggal_Lahir, status_diri, Pendidikan,Jurusan_Pondok,Warganegara,Kewarganegaraan,Anak_ke, Jumlah_Saudara,Status_anak, Status_Mukim,Bahasa,Alamat_Lengkap,No_hp,Kelompok,Desa,Daerah,Status_Pondok,utusan,Tanggal_Masuk_CKM,mulai_pengajian,Tinggal_dengan,Penanggung_Jawab,No_HP_Penanggung_Jawab,Tanggal_Masuk,Nama_Ayah,Alamat_Ayah,No_HP_Ayah,Nama_Ibu,Alamat_Ibu,NO_Telp_Ibu,Pekerjaan_Ayah,Pekerjaan_Ibu,MKTime,Status_Siswa,pindah_pondok,Keterangan,Tanggal_Kelas,Tahun_Ajaran FROM tb_siswa WHERE  id_sekolah = 4 AND Tahun_Ajaran = '".$tahun_ajaran."'";     
...
/*$grid->setColProperty('Status_Mukim', array("formoptions"=>array("label"=>"St. Mukim","elmsuffix"=>"(Wajib Isi)"),"edittype"=>"select","editrules"=>array("required"=>true), "editoptions"=>array("tabindex"=>6,"value"=>"Mukim:Mukim;Non Mukim:Non Mukim; : ")));
*/
...
$grid->setColProperty('NO_KTP', array("searchrules"=>array(
		"required"=>true,
		"number"=>false),"formoptions"=>array("label"=>"No KTP"),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("tabindex"=>4)));
...
$grid->setColProperty('Jenis_Kelamin', array("formoptions"=>array("label"=>"Jenis Kelamin","elmsuffix"=>"(Wajib Isi)"),"edittype"=>"select","editrules"=>array("required"=>true), "editoptions"=>array("tabindex"=>6,"value"=>" : ;L:L;P:P","required"=>true)));
$grid->setColProperty('Tempat_Lahir', array("label"=>"Tempat Lahir","editrules"=>array("required"=>true),"editoptions"=>array("tabindex"=>7,"size"=>30,"required"=>true,"readonly"=>false)));
...
$grid->setColProperty('Tanggal_Lahir', 
        array("formoptions"=>array("elmsuffix"=>""),"formatter"=>"date","datefmt"=>'d/m/Y',
            "formatoptions"=>array("srcformat"=>"d/m/Y H:i:s", "newformat"=>"d/m/Y"),
			"editrules"=>array("required"=>true),
...
*/
$grid->setColProperty('Tinggal_dengan', array("label"=>"Tinggal Dengan","edittype"=>"select","editrules"=>array("edithidden"=>true,"required"=>false), "editoptions"=>array("tabindex"=>10,"value"=>" : ;Rumah Orang Tua:Rumah Orang Tua;Rumah Saudara:Rumah Saudara;Rumah Wali:Rumah Wali;Asrama:Asrama;Kost:Kost;Lainnya:Lainnya")));
...
$grid->setColProperty('Jumlah_Saudara', array("label"=>"Jumlah Saudara","editoptions"=>array("tabindex"=>16),"editrules"=>array("edithidden"=>true,"required"=>false)));
...
$grid->setColProperty('Daerah', array("label"=>"Daerah","formoptions"=>array("rowpos"=>5,"colpos"=>2,"elmsuffix"=>"&nbsp;(Wajib Isi)"),"editrules"=>array("edithidden"=>true,"required"=>true),"editoptions"=>array("required"=>true)));
/*
...
*/
$grid->setColProperty('Penanggung_Jawab', array("label"=>"Penanggung Jawab","formoptions"=>array("rowpos"=>6,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('No_HP_Penanggung_Jawab', array("label"=>"No HP Penanggung Jawab","formoptions"=>array("rowpos"=>7,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("required"=>true)));
$grid->addCol(array("name"=>"fileToUpload","label"=>"Upload Foto", "hidden"=>true,"formoptions"=>array("rowpos"=>18,"colpos"=>2), "editable"=>true, "edittype"=>"file", "editrules"=>array("edithidden"=>true)));

$grid->setColProperty('Nama_Ayah', array("label"=>"Nama Ayah","formoptions"=>array("rowpos"=>8,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>true),"editoptions"=>array("required"=>true)));
$grid->setColProperty('Alamat_Ayah', array("label"=>"Alamat ayah","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("rows"=>2,"cols"=>30,"required"=>true),"formoptions"=>array("rowpos"=>9,"colpos"=>2)));
$grid->setColProperty('No_HP_Ayah', array("label"=>"No HP Ayah","formoptions"=>array("rowpos"=>10,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("required"=>true)));
;
$grid->setColProperty('Pekerjaan_Ayah', array("label"=>"Pekerjaan Ayah","formoptions"=>array("rowpos"=>11,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Nama_Ibu', array("label"=>"Nama Ibu","formoptions"=>array("rowpos"=>12,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Alamat_Ibu', array("label"=>"Alamat Ibu","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("rows"=>2,"cols"=>30),"formoptions"=>array("rowpos"=>13,"colpos"=>2)));
$grid->setColProperty('NO_Telp_Ibu', array("label"=>"No HP Ibu","formoptions"=>array("rowpos"=>14,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Pekerjaan_Ibu', array("label"=>"Pekerjaan Ibu","formoptions"=>array("rowpos"=>15,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('pindah_pondok', array("label"=>"Pindah Pondok","formoptions"=>array("rowpos"=>16,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));

$grid->setSelect("id_sekolah", "SELECT DISTINCT id_sekolah, nama_sekolah AS nama_sekolah FROM mst_tb_sekolah WHERE id_sekolah = 4 ORDER BY 1", true, true, true, array(""=>"All"));

$grid->setSelect("id_tingkat", "SELECT DISTINCT id, Tingkat AS Tingkat FROM mst_tb_tingkat WHERE id_sekolah = 4 ORDER BY 1", true, true, true, array(""=>"All"));
...
$custom = <<<CUSTOM
jQuery("#cetakformulirsd").click(function(){
	var selr = $('#grid_sd').jqGrid('getGridParam','selrow');
    var qID = $('#grid_sd').jqGrid('getCell',selr,'id');
...
/*$grid->setAfterCrudAction('add', "INSERT INTO  tb_biaya_pondok (id_siswa,id_biaya,Jumlah,Tahun_Ajaran) (SELECT (SELECT id FROM tb_siswa WHERE MKTime = ?),  id , Biaya, CASE WHEN MONTH(NOW()) < 3 THEN YEAR(NOW()) - 1 ELSE YEAR(NOW())  END  FROM mst_tb_komponen_biaya WHERE  Status_Biaya = 'Aktif' AND (Kategori = 'Sekolah & Person' OR Kategori = 'Sekolah')  ORDER BY  No_Urut)",array($cid));*/
...
/*$grid->setAfterCrudAction('add', "INSERT INTO  tb_histori_kelas (id_siswa,id_tingkat,id_kelas,Tahun_Ajaran)  VALUES (SELECT (SELECT id FROM tb_siswa WHERE MKTime = ?),(SELECT id_tingkat FROM tb_siswa WHERE MKTime = ?),(SELECT kelas FROM tb_siswa WHERE MKTime = ?),CASE WHEN MONTH(NOW()) < 6 THEN YEAR(NOW()) ELSE YEAR(NOW())  END)",array($cid));

$grid->setAfterCrudAction('add', "INSERT INTO tb_biaya_sekolah (id_siswa,id_tingkat,id_biaya,Jumlah,Jum_Seragam,Tahun_Ajaran) 
  (SELECT (SELECT id FROM tb_siswa WHERE MKTime = ?),(SELECT id_tingkat FROM tb_siswa WHERE MKTime = ?),id,Biaya,'1',CASE WHEN MONTH(NOW()) < 6 THEN YEAR(NOW()) ELSE YEAR(NOW())  END FROM mst_tb_komponen_biaya WHERE id_tingkat = '".$Tingkat."' AND id_sekolah = '".$idsekolah."' AND Status_Biaya = 'AKTIF')",array($cid));*/
...
// Enjoy
$grid->renderGrid('#grid_sd','#pager_sd',true, null, null, true,true);
$conn = null;
?>
