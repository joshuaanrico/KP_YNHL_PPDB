...
// Write the SQL Query
$grid->SelectCommand = "SELECT id,id_sekolah,NISS,detail_kelas,Kelas,Kelas_Pondok, Nama_Lengkap,NO_KTP, Nama_Panggilan, Jenis_Kelamin, Tempat_Lahir, Tanggal_Lahir, status_diri, Pendidikan,Jurusan_Pondok,Warganegara,Kewarganegaraan,Anak_ke, Jumlah_Saudara,Status_anak, Bahasa,Alamat_Lengkap,No_hp,Kelompok,Desa,Daerah,Status_Pondok,utusan,Tanggal_Masuk_CKM,mulai_pengajian,Tinggal_dengan,Penanggung_Jawab,No_HP_Penanggung_Jawab,Tanggal_Masuk,Nama_Ayah,Alamat_Ayah,NO_Telp_Ayah,NO_HP_ayah,Nama_Ibu,Alamat_Ibu,NO_Telp_Ibu,Pekerjaan_Ayah,Pekerjaan_Ibu,MKTime,Status_Siswa,pindah_pondok,Keterangan,kelompok_pondok,Tanggal_Kelas FROM tb_siswa WHERE  id_sekolah = 5 ";   //AND Tahun_Ajaran = '".$_SESSION["tahun_ajaran"]."'  
...
$Model = array(   
	...
	array("name"=>"Kelompok","width"=>20,"hidden"=>true),
...
$grid->setColProperty('Nama_Lengkap', array("label"=>"Nama Lengkap","formoptions"=>array("elmsuffix"=>"&nbsp;&nbsp;&nbsp;(Wajib Isi)"),"editrules"=>array("edithidden"=>true,"required"=>true,"readonly"=>false),"editoptions"=>array("tabindex"=>2,"size"=>35,"required"=>true,"readonly"=>false)));
...
$grid->setColProperty('NO_KTP', array("searchrules"=>array(
		"required"=>true,
		"number"=>false),"formoptions"=>array("label"=>"No KTP","elmsuffix"=>"(Wajib Isi)"),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("tabindex"=>4)));
$grid->setColProperty('Tanggal_Masuk', 
        array("formoptions"=>array("label"=>"Tanggal Masuk","elmsuffix"=>"(Wajib Isi)"),"formatter"=>"date","datefmt"=>'d/m/Y',
...
$grid->setColProperty('Jenis_Kelamin', array("formoptions"=>array("label"=>"JK","elmsuffix"=>"(Wajib Isi)"),"edittype"=>"select","editrules"=>array("required"=>true), "editoptions"=>array("tabindex"=>6,"value"=>" : ;L:L;P:P")));
$grid->setColProperty('Tempat_Lahir', array("label"=>"Tempat Lahir","editrules"=>array("required"=>true),"editoptions"=>array("tabindex"=>7,"size"=>30,"readonly"=>false)));
...
$grid->setColProperty('Tinggal_dengan', array("label"=>"Status","edittype"=>"select","editrules"=>array("edithidden"=>true,"required"=>false), "editoptions"=>array("tabindex"=>10,"value"=>" : ;Rumah Orang Tua:Rumah Orang Tua;Rumah Saudara:Rumah Saudara;Rumah Wali:Rumah Wali;Asrama:Asrama;Kost:Kost;Lainnya:Lainnya")));
...
$grid->setColProperty('Kelompok', array("label"=>"Kelompok","formoptions"=>array("rowpos"=>2,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>true)));
$grid->setColProperty('Desa', array("label"=>"Desa","formoptions"=>array("rowpos"=>3,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Daerah', array("label"=>"Daerah","formoptions"=>array("rowpos"=>4,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>true)));
$grid->setColProperty('mulai_pengajian', array("label"=>"Mulai Mengaji","formoptions"=>array("rowpos"=>5,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Status_Pondok', array("label"=>"Status Mondok","formoptions"=>array("rowpos"=>6,"colpos"=>2, "elmsuffix"=>"(Wajib Isi)"),"edittype"=>"select","editrules"=>array("required"=>true), "editoptions"=>array("value"=>" : ;CKM:CKM;Person:Person")));
$grid->setColProperty('utusan', array("label"=>"Utusan","formoptions"=>array("rowpos"=>7,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Tanggal_Masuk_CKM', array("label"=>"Tanggal Masuk CKM","formoptions"=>array("rowpos"=>8,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
...
$grid->setColProperty('Penanggung_Jawab', array("label"=>"Penanggung Jawab","formoptions"=>array("rowpos"=>10,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('No_HP_Penanggung_Jawab', array("label"=>"No HP Penanggung Jawab","formoptions"=>array("rowpos"=>11,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->addCol(array("name"=>"fileToUpload","label"=>"Upload Foto", "hidden"=>true,"formoptions"=>array("rowpos"=>22,"colpos"=>2), "editable"=>true, "edittype"=>"file", "editrules"=>array("edithidden"=>true)));

$grid->setColProperty('Nama_Ayah', array("label"=>"Nama Ayah","formoptions"=>array("rowpos"=>12,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>true)));
$grid->setColProperty('Alamat_Ayah', array("label"=>"Alamat ayah","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("rows"=>2,"cols"=>30),"formoptions"=>array("rowpos"=>13,"colpos"=>2)));
$grid->setColProperty('NO_HP_Ayah', array("label"=>"No HP Ayah","formoptions"=>array("rowpos"=>16,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
;
$grid->setColProperty('Pekerjaan_Ayah', array("label"=>"Pekerjaan Ayah","formoptions"=>array("rowpos"=>17,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Nama_Ibu', array("label"=>"Nama Ibu","formoptions"=>array("rowpos"=>18,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Alamat_Ibu', array("label"=>"Alamat Ibu","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("rows"=>2,"cols"=>30),"formoptions"=>array("rowpos"=>20,"colpos"=>2)));
$grid->setColProperty('NO_Telp_Ibu', array("label"=>"No Telp Ibu","formoptions"=>array("rowpos"=>19,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Pekerjaan_Ibu', array("label"=>"Pekerjaan Ibu","formoptions"=>array("rowpos"=>21,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('pindah_pondok', array("label"=>"Pindah Pondok","formoptions"=>array("rowpos"=>21,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));

$grid->setSelect("id_sekolah", "SELECT DISTINCT id_sekolah, nama_sekolah AS nama_sekolah FROM mst_tb_sekolah WHERE  id_sekolah = 5 ORDER BY 1", true, true, true, array(""=>"All"));
...
$custom = <<<CUSTOM
jQuery("#cetakformulirckmp").click(function(){
	var selr = $('#grid').jqGrid('getGridParam','selrow');
    var qID = $('#grid').jqGrid('getCell',selr,'id');
    ...
    if(qID) 	
	{
		$("#dialog-print").dialog({
										 ...
										 $.get("identitas_santri.php?NoP="+qID, function(data,status) {
											  if (status == "success") {	
...
jQuery("#getpembayaran").click(function(){
    var selr = $('#detail').jqGrid('getGridParam','selrow');
    var qIDs = $('#detail').jqGrid('getCell',selr,'id');
...
$grid->setAfterCrudAction('add', "UPDATE tb_siswa SET Status_Siswa = 'Aktif' WHERE MKTime=?",array($cid));
$grid->setAfterCrudAction('add', "UPDATE tb_siswa SET Status_Mukim = 'Mukim' WHERE MKTime=?",array($cid));
