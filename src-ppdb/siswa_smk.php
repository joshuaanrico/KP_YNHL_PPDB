...
$grid->setColProperty('Tempat_Lahir', array("label"=>"Tempat Lahir","editrules"=>array("required"=>true),"editoptions"=>array("tabindex"=>7,"size"=>30,"readonly"=>false),"editoptions"=>array("required"=>true)));
...
$grid->setColProperty('Daerah', array("label"=>"Daerah","formoptions"=>array("rowpos"=>5,"colpos"=>2,"elmsuffix"=>"(Wajib Isi)"),"editrules"=>array("edithidden"=>true,"required"=>true)));
...
$grid->setColProperty('Penanggung_Jawab', array("label"=>"Penanggung Jawab","formoptions"=>array("rowpos"=>9,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('No_HP_Penanggung_Jawab', array("label"=>"No HP Penanggung Jawab","formoptions"=>array("rowpos"=>10,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("required"=>true)));
...
$grid->setColProperty('Nama_Ayah', array("label"=>"Nama Ayah","formoptions"=>array("rowpos"=>12,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>true),"editoptions"=>array("required"=>true)));
$grid->setColProperty('Alamat_Ayah', array("label"=>"Alamat ayah","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("rows"=>2,"cols"=>30),"formoptions"=>array("rowpos"=>16,"colpos"=>2),"editoptions"=>array("required"=>true)));
$grid->setColProperty('No_HP_Ayah', array("label"=>"No HP Ayah","formoptions"=>array("rowpos"=>13,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("required"=>true)));
;
$grid->setColProperty('Pekerjaan_Ayah', array("label"=>"Pekerjaan Ayah","formoptions"=>array("rowpos"=>15,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Nama_Ibu', array("label"=>"Nama Ibu","formoptions"=>array("rowpos"=>20,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("required"=>true)));
$grid->setColProperty('Alamat_Ibu', array("label"=>"Alamat Ibu","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("rows"=>2,"cols"=>30),"formoptions"=>array("rowpos"=>23,"colpos"=>2)));
$grid->setColProperty('NO_Telp_Ibu', array("label"=>"No HP Ibu","formoptions"=>array("rowpos"=>21,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('Pekerjaan_Ibu', array("label"=>"Pekerjaan Ibu","formoptions"=>array("rowpos"=>22,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));
$grid->setColProperty('pindah_pondok', array("label"=>"Pindah Pondok","formoptions"=>array("rowpos"=>22,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));

$grid->setSelect("id_sekolah", "SELECT DISTINCT id_sekolah, nama_sekolah AS nama_sekolah FROM mst_tb_sekolah WHERE id_sekolah = 3 ORDER BY 1", true, true, true, array(""=>"All"));

$grid->setSelect("id_tingkat", "SELECT DISTINCT id, Tingkat AS Tingkat FROM mst_tb_tingkat WHERE id_sekolah = 3 ORDER BY 1", true, true, true, array(""=>"All"));
...
$custom = <<<CUSTOM
jQuery("#cetakformulirsmk").click(function(){
	var selr = $('#grid_smk').jqGrid('getGridParam','selrow');
    var qID = $('#grid_smk').jqGrid('getCell',selr,'id');
...
// Enjoy
$grid->renderGrid('#grid_smk','#pager_smk',true, null, null, true,true);
$conn = null;
?>
