...
$grid->setColProperty('Keterangan', array("label"=>"Prestasi/Hobi/Keterampilan","edittype"=>"textarea","editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("tabindex"=>24,"rows"=>2,"cols"=>30)));
...
$grid->setColProperty('Penanggung_Jawab', array("label"=>"Penanggung Jawab","edittype"=>"select","formoptions"=>array("rowpos"=>9,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false),"editoptions"=>array("value"=>" : ;Ayah:Ayah;Ibu:Ibu;Wali:Wali")));
...
$grid->addCol(array("name"=>"fileToUpload","label"=>"Upload Foto", "hidden"=>true,"formoptions"=>array("rowpos"=>25,"colpos"=>2), "editable"=>true, "edittype"=>"file", "editrules"=>array("edithidden"=>true)));
...
$grid->setColProperty('pindah_pondok', array("label"=>"Pindah Pondok","formoptions"=>array("rowpos"=>26,"colpos"=>2),"editrules"=>array("edithidden"=>true,"required"=>false)));

$grid->setSelect("id_sekolah", "SELECT DISTINCT id_sekolah, nama_sekolah AS nama_sekolah FROM mst_tb_sekolah WHERE id_sekolah = 2 ORDER BY 1", true, true, true, array(""=>"All"));

$grid->setSelect("id_tingkat", "SELECT DISTINCT id, Tingkat AS Tingkat FROM mst_tb_tingkat WHERE id_sekolah = 2 ORDER BY 1", true, true, true, array(""=>"All"));
...
$custom = <<<CUSTOM
jQuery("#cetakformulirsma").click(function(){
	var selr = $('#grid_sma').jqGrid('getGridParam','selrow');
    var qID = $('#grid_sma').jqGrid('getCell',selr,'id');
...
// Enjoy
$grid->renderGrid('#grid_sma','#pager_sma',true, null, null, true,true);
$conn = null;
?>
